...
<body>
  <div class="container" style="width: 70%">
		...
		<div class="row"><h1 class="page-header" style="text-align: center; margin-bottom: 50px;">${row.pname}</h1>
		...
		<div class="row productInfo" style="width: 40%; float: right;" >
			<div class="form-group" style="text-align: center;">
				<h3 class="page-header"><span>${productInfo.pname}</span><br><small>${productInfo.productInfo}</small></h3>
			</div>
			<div class="form-group" style="text-align: left;">
				<label>가격 : </label><span>&nbsp;<fmt:formatNumber value="${product.pprice}" type="number"/></span><span>&nbsp;원</span>
				<input type="hidden" value="${productInfo.pprice}" id="price">
			</div>
			<div class="form-group" style="text-align: left;">
